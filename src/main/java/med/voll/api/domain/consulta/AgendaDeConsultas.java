...
import med.voll.api.domain.consulta.validacoes.cancelamento.ValidacaoCancelamentoDeConsulta;
...
public class AgendaDeConsultas {
    ...
    private Medico escolherMedico(DadosAgendamentoConsulta dados) {
        ...
        if (dados.especialidade() == null) {
            throw new ValidacaoException("É obrigatório o preenchimento da especialidade caso o médico nao for selecionado");
        }
